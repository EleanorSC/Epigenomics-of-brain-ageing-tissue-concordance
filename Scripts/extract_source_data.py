...
This is the DATA-GENERATION step — it reads the raw journal supplementary
files and applies the |r| / |rho| > 0.6 threshold. It is upstream of
build_cpg_database.py, which only assembles the final formatted .xlsx from
these two CSVs.
